                ...
                <div class="row">
                    <div class="col-sm-3">
                        <div class="card support-bar overflow-hidden">
                            <div class="card-body pb-0">
                                <h2 class="m-0">350</h2>
                                <span class="text-c-blue">Tow Requests</span>
                                <p class="mb-3 mt-3">Total number of Tow requests that come in.</p>
                            </div>
                    ...
                    <div class="col-sm-3">
                        <div class="card support-bar overflow-hidden">
                            <div class="card-body pb-0">
                                <h2 class="m-0">200</h2>
                                <span class="text-c-green">Park Activities</span>
                                <p class="mb-3 mt-3">Total number of Parks .</p>
                            </div>
