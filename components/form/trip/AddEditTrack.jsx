          ...
          <div className="card-body">
            <div className="col-md-12 ">
              <form onSubmit={handleSubmit(onSubmit)}>
                ...
                <div className="form-group row">
                  <label className="col-form-label col-md-2">Driver Name</label>
                ...
                <div className="form-group row">
                  ...
                  <label className="col-sm-2 col-form-label">Vehicle Id</label>
                ...
                <div className="form-group row">
                  <label className="col-form-label col-md-2">Driver Note</label>
                  <div className="col-md-10">
                    <input
                      name="DriverNote"
                      className="form-control"
